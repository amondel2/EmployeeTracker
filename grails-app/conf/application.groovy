...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.attend.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.attend.UserRole'
grails.plugin.springsecurity.authority.className = 'com.attend.Role'
